...
TEST_F(TestVcfAlleleMerger, deletion) {
    ...
    ASSERT_EQ(1u, am.mergedAlt().size());
...
TEST_F(TestVcfAlleleMerger, identical) {
    ...
    ASSERT_EQ(0u, am.newGt()[0][0]);
    ASSERT_EQ(0u, am.newGt()[1][0]);
}
